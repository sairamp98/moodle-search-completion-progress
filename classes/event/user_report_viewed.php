...
/**
 * The report_cpm_completion user report viewed event.
 *
 * @package    report
...
namespace report_cpm_completion\event;
...
class user_report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventuserreportviewed', 'report_cpm_completion');
    }
    ...
    protected function get_legacy_logdata() {
        $url = 'report/cpm_completion/user.php?id=' . $this->relateduserid . '&course=' . $this->courseid;
    ...
    public function get_url() {
        return new \moodle_url('/report/cpm_completion/user.php', array('course' => $this->courseid, 'id' => $this->relateduserid));
    }
